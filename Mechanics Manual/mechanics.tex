...
% directory:
%
% 1) pdflatex mechanics
% 2) makeindex mechanics.idx -s StyleInd.ist
% 3) biber mechanics
% 4) pdflatex mechanics
%
...
Mechanics Manuall \par % Book title
\vspace*{1cm}
{\Huge Tharon Morrison}\par % Author name
\endgroup
...
\noindent Copyright \copyright\ 2013 Tharon Morrison\\ % Copyright notice
